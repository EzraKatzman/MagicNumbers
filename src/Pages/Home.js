                ...
                <div className='text-center'>
                    ...
                    <div className='sm:flex sm:justify-center sm:items-center'>
                        <div className='m-2 p-2 sm:w-1/3'>
                            <svg className='block mx-auto h-10 w-10 m-2 p-1 text-tgray-50 bg-lime-600 dark:bg-lime-700 rounded-md' xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 24 24' stroke='currentColor'>
                        ...
                        <div className='m-2 p-2 sm:w-1/3'>
                            <svg className='block mx-auto h-10 w-10 m-2 p-1 text-tgray-50 bg-cyan-600 dark:bg-cyan-700 rounded-md' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div className='m-2 p-2 sm:w-1/3'>
                            <svg className='block mx-auto h-10 w-10 m-2 p-1 text-tgray-50 bg-red-600 dark:bg-red-700 rounded-md' xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 24 24' stroke='currentColor'>
