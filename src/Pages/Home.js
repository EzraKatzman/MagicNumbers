            ...
            <section className='m-4'>
                <div className='text-center'>
                    ...
                    <div className='p-2 mt-2'>
                        ...
                        <Link to='/signup' className='p-2 text-md font-bold text-tgray-50 bg-cyan-600 dark:bg-cyan-700 hover:bg-cyan-700 dark:hover:bg-cyan-600 rounded-full'>Join Now</Link>
                    </div>
