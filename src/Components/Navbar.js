    ...
    return (
        <header className='sm:grid sm:grid-cols-3 sm:items-center py-4 px-2 border-b border-tgray-200 mb-14 sm:mb-20 xl:mb-8 dark:bg-tgray-900'>
            <div className='flex items-center justify-between px-4 sm:p-0'>
                <div>
                    <Link to='/' className='block font-semibold italic logo text-purple-600 dark:text-purple-700'>Magic Numbers</Link>
                </div>
            ...
            <nav className={`${isOpen ? 'block' : 'hidden'} px-4 py-2 pb-4 sm:flex sm:p-0 text-center uppercase justify-self-center`}>
              <Link to='/problems' className='block my-1 px-2 py-1 font-semibold hover:bg-tgray-200 dark:hover:bg-tgray-700 dark:text-tgray-50 rounded-full'>Problems</Link>
              <Link to='/leaders' className='block my-1 px-2 py-1 font-semibold hover:bg-tgray-200 dark:hover:bg-tgray-700 dark:text-tgray-50 rounded-full'>Leaderboard</Link>
              <Link to='/login' className='block my-1 px-2 py-1 font-semibold hover:bg-tgray-200 dark:hover:bg-tgray-700 dark:text-tgray-50 rounded-full'>Login</Link>
              <Link to='/signup' className='block my-1 px-2 py-1 font-semibold hover:bg-tgray-200 dark:hover:bg-tgray-700 dark:text-tgray-50 rounded-full'>Sign up</Link>
